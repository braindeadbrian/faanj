    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <p>Fujian American Association of New Jersey</p>
              <p>123 Main Street</p>
              <p>New Jersey, NJ 07000</p>
              <p>Phone: (123) 456-7890</p>
              <p>Email: info@faanj.org</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/resources" className="hover:text-red-400">
                  Resources
                </Link>
              </li>
              <li>
                <Link href="/membership" className="hover:text-red-400">
                  Membership
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center">
          <p>&copy; {new Date().getFullYear()} Fujian American Association of New Jersey. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
